...
import json
from models.best.Poseidon_ver1 import Poseidon
        ...
        while True:
            ...
            for box in dets.boxes:
                ...
                for b in range(hm.shape[0]):
                    ...
                    print(f"{b}回目 image_id:{image_id},ann_id:{ann_id}")
                    image_id +=1
                    ann_id += 1
